...
class RegressionTest(PikaurDbTestCase):
    ...
    def test_explicit_pkgs_not_becoming_deps(self):
        ...
        explicitly_installed_dep_old_version = self.downgrade_aur_pkg(
            explicitly_installed_dep_name, fake_makepkg=True, version_count=1,
        )
    ...
    # # @TODO: commented-out since idk with which other AUR pkg to reproduce
    # #        it after `guitar-pro` pkg got removed from the AUR.
